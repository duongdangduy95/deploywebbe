...
mongoose
    .connect("mongodb+srv://20225185:20225185@20225185.sgsfupf.mongodb.net/it4409")
...
app.get("/api/users", async (req, res) => {
    ...
    const maxLimit = 50; // Giới hạn tối đa record trả về
...
try {
        ...
        const updateData = {};
        const allowedUpdates = ['name', 'age', 'email', 'address'];
